            ...
            <div className="footer-main">
                ...
                <div className="container">
                    <ul className="widget-social">
                        <li>
                            <a href='https://twitter.com/Travelerse1' target='_blank' rel='noreferrer'>
                        ...
                        <li>
                            <a href='https://t.me/Travelerse' target='_blank' rel='noreferrer'>
                    ...
                    <h5 className="heading">Lock, Earn, Travel</h5>
